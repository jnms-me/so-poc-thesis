...
% geen idee welke hosts vertrouwd kunnen worden met welk soort communicatie
% Met documentatie hierover kunnen (manueel) `Policy violation' NIDS rulesets gemaakt worden.
% time investment, maar zeker mogenlijk
