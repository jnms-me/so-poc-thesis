...
|- thehive
  ...
  \end{lstlisting}
  \caption{Overzicht van de structuur van bestanden in het project}
...
% Nginx logo
% Let's Encrypt
Merk op dat in figuur \ref{fig:so-poc-structuur-docker-compose-containers} elke applicatie een \emph{proxy} container heeft.
...
\\
Aangezien de combinatie van de RAID controller en de harde schijven aanwezig in de server resulteerde in minstens 2 logische schijven, heb ik 1 schijf toegewezen aan de Debian host en de andere aan de Security Onion vm.
