...
% alerts moeten niet gebruikt worden
% kunnen op read gezet worden
...
\subsection{MISP}
% Ook mogelijk om cortex analysers te gebruikten op attibutes, lijkt niet meer ondersteund, hier niet geraakt
