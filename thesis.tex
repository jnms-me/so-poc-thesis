...
De uitzonderingen hierop zijn de built-in devices zoals de hub, switch, NAT en cloud.
...
Figuur ref is een overzicht van de gekozen opties.
...
gns3-so-appliance.png

\subsection{Simulatie bedrijfsnetwerk}

Elke switch is een instantie van Open vSwitch
alternatief was hub, port mirror is 1 richting en beter beheerbaar.
