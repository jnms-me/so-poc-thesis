...
\section{Ntop}
% Focus ligt niet op security, wel gedetailleerd een log bijhouden van netwerkactiviteit.
% Duidelijk inzicht in volumes data
% First seen en evt alerts kunnen als begin gebruikt worden van een onderzoek
\section{Netdata}
% Troubleshooten Docker compose systeem en server
% Alerts over RAM usage en vooral geschiedenis packet loss
% Geconfigureerd om verschillende containers te monitoren.
% Grafieken en alerts van Elasticsearch clusters (niet verbonden met so), sql, nginx...
