...
In grotere systemen worden deze logs centraal verzameld om deze anomali\"en effectief te kunnen analyseren.
...
Om regels zo effectief mogelijk te maken, worden er variabelen ge\"introduceerd.
...
Ten slotte kan ERSPAN op de zelfde manier gebruikt een port mirror te transporteren over een laag 3 netwerk.
\autocite{cisco:span}
